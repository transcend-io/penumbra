/**
 * From https://github.com/kourge/ts-brand (no ESM export)
 */
 ...
 */
export type AnyBrand = Brand<unknown, any>; // eslint-disable-line @typescript-eslint/no-explicit-any
 ...
 * @returns The same underlying value, but casted
 * @example
 * ```
 * type UserId = Brand<number, 'user'>;
 ...
 * @param validator - A function that asserts on the value
 * @example
 * ```
 * type UserId = Brand<number, 'user'>;
